...
class simple_videoplayer(object):
...
"""
    ...
    parser.add_argument('--gpio-pins', default=simple_videoplayer._GPIO_PIN_DEFAULT,
                        action=_GpioParser,
    ...
    while countdown > 0:
        sys.stdout.write(
            '\rrpi-simple_videoplayer starting in {} seconds '
    ...
    simple_videoplayer(**vars(args)).start()
